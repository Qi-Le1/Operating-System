...
void focus_program( char *data, int length )
{
	...
	// {
	// 	cout << "第二次data [" << i << "] :"  << (int)data[i] << endl;
	// 	cout << "第二次data_verify [" << i << "] :"  << (int)data_verify[i] << endl;
    // }
...
{	
	...
	// 	cout << "data_verify [" << i << "] :"  << (int)data_verify[i] << endl;
    // }
	...
	// for (unsigned i = 0; i < 50; i++)
	// {
	// 	cout << "第二次 data [" << i << "] :"  << (int)data[i] << endl;
	// 	cout << "第二次 data_verify [" << i << "] :"  << (int)data_verify[i] << endl;
    // }
